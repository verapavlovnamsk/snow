 ...
 window.onload = function() {
  ...
  window.requestAnimFrame = (function() {
    ...
    return  window.requestAnimationFrame       ||
            window.webkitRequestAnimationFrame || // comment out if FF4 is slow 
  ...
  function createSnow() {
    ...
    var particleOpacity = .5;
    // var particlesnew = Object.create (particles);
    // Initialize canvas
    ...
    // incremental 'angle' that will iterate through each particle flow for dynamic and organic flow.
    var angle = 0.005;
